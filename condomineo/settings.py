...
ALLOWED_HOSTS = [h.strip() for h in config('ALLOWED_HOST', default='*').split(',') if h.strip()]
...
SOCIALACCOUNT_ALLOW_REDIRECTS = True
...
# Configurações de CORS - ajustadas para permitir cookies e headers CSRF
