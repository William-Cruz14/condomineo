    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tread', models.IntegerField(blank=True, null=True, verbose_name='Piso')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('communication_type', models.CharField(choices=[('notice', 'Notice'), ('message', 'Message')], default='message', help_text='Selecione o tipo de comunicação.', max_length=20, verbose_name='Tipo de Comunicação')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('recebido', 'Recebido'), ('entregue', 'Entregue')], default='recebido', help_text='Selecione o status atual do pedido.', max_length=20, verbose_name='Status do Pedido')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpf', models.CharField(help_text='Apenas números, sem pontos ou traços.', max_length=11, unique=True, verbose_name='Cadastro de Pessoa Física (CPF)')),
                ('email', models.EmailField(blank=True, max_length=255, null=True, verbose_name='Email do Dependente')),
                ('phone', models.CharField(blank=True, max_length=11, null=True, verbose_name='Telefone do Morador')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Data de Criação')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpf', models.CharField(help_text='Apenas números, sem pontos ou traços.', max_length=11, verbose_name='Cadastro de Pessoa Física (CPF)')),
