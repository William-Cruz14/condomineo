# Generated by Django 5.2rc1 on 2025-05-13 20:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to=settings.AUTH_USER_MODEL, verbose_name='Morador')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visiting', models.ManyToManyField(related_name='visitors', to=settings.AUTH_USER_MODEL, verbose_name='Anfitriões')),
            ],
            options={
